...
% ------------------------------------------------------- 
\section{Summary}
Developer with over two and a half years of experience, currently working as a backend engineer in fintech. Experienced in development of microservices, from inception to deployment and maintenance. Recently engineered microservices to pull, encrypt, and manage sensitive financial data of customers, spearheading the full development process from initial analysis to design, development, testing, and deployment. Previously worked on building of automation tools to streamline legal processes in conveyancing. Strong dedication to continuous learning, as demonstrated by pursuing postgraduate modules in Computer Science and AI at the University of York alongside full-time employment.
% ------------------------------------------------------- 
% LEFT COLUMN
% ------------------------------------------------------- 
\begin{paracol}{2}
