...
\newcommand{\contacts}[5]{
  {\noindent\rmfamily\small\color{BodyGrey}\bfseries
    {\color{LightGrey}\faEnvelope}\hspace{5pt}#1\hspace{12pt}   % Personal Email
    {\color{LightGrey}\faBriefcase}\hspace{5pt}#2\hspace{12pt}   % Work Email
...
{\color{TitleGrey}\rmfamily\bfseries}{}{0em}{}
...
Backend Engineer currently working at Spotify within data infrastructure. Prior experience consists of builing open banking integrations in the field of fintech, and automation of legal processes in the conveyancing domain. Committed to continuous learning, as demonstrated by pursuing postgraduate modules in Computer Science and AI alongside full-time emloyment, applying insights from its undertaking to real-world challenges.
  ...
  {\color{black}\rmfamily\bfseries}{}{0em}{}
