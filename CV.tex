...
\begin{paracol}{2}
  ...
  % ------------------------------------------------------- 
  \section{Summary}
  Backend Engineer currently working at Spotify, specialising in Lorem Ipsum. Recently spearheaded Lorem Ipsum Dolor Sit Amec. Prior experience consists of builing open banking integrations in the field of fintech, and automation of legal processes in the conveyancing domain. Committed to continuous learning, as demonstrated by pursuing postgraduate modules in Computer Science and AI alongside full-time emloyment, applying insights from its undertaking to real-world challenges.
  \raggedright
  \vspace{3pt}
  % ------------------------------------------------------- 
  % Experience
  ...
  {\color{LightGrey}\scriptsize\href{https://www.spotify.com/uk/about-us/contact/}{\faExternalLink}}
  {\color{TitleGrey}{\small an audio streaming and media service provider.}}
  \hspace*{\fill}{\color{TitleGrey}{\scriptsize\faCalendar}\hspace{5pt}{\small06/2025 -- Present}}

  \begin{itemize}[leftmargin=*]
    \setlength\itemsep{-2pt}
    \item Lorem ipsum dolor sit amec, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
...
% ------------------------------------------------------- 
  ...
  % Reset body colour
  \color{BodyGrey}
  % Reset subsection titleformat
  \titleformat{\subsection}
  {\color{black}\rmfamily\large\bfseries}{}{0em}{}
  \subsection{PGCert Computer Science and AI}
