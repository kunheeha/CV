...
\begin{paracol}{2}
  ...
  {\noindent\small a fintech technology company that provides a digitised ROSCA system.}
  ...
  \begin{itemize}[leftmargin=*]
    ...
    \item Applied WEKA extensively in modules related to data analytics and machine learning, gaining practical experience
  \end{itemize}
